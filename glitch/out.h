...
#ifdef USE_PROGMEM
static const ASTA asta [23] PROGMEM = {
#else
static const ASTA asta [23] = {
#endif
	1, 1, "SHOW", 0, 0, 2, 6, "",
	...
	18, 1, "CONFIGURE", 0, 0, 19, 20, "",
	19, 1, "TERMINAL", 0, 18, 0, 0, "",
	20, 1, "REBOOT", 1, 0, 0, 21, "REBOOT",
	21, 6, "param-integer", 0, 0, 22, 0, "",
	22, 1, "ON", 1, 21, 0, 23, "BLOCK_ID_ON",
	23, 1, "OFF", 1, 21, 0, 0, "BLOCK_ID_OFF",
};
...
#ifdef USE_PROGMEM
static const XLATMap func_map [13] PROGMEM = {
#else
static const XLATMap func_map [13] = {
#endif
	"SHOW_BLOCKS", 0,
	"SHOW_SYSTEM", 1,
	"SHOW_BLOCK_LABEL", 2,
